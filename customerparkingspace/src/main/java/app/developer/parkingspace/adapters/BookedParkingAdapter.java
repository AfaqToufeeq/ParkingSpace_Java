...
public class BookedParkingAdapter extends RecyclerView.Adapter<BookedParkingAdapter.ViewHolder> {
    ...
    @NonNull
    @Override
    public BookedParkingAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater layoutInflater = LayoutInflater.from(parent.getContext());
        View listItem= layoutInflater.inflate(R.layout.booked_layout, parent, false);
        return new BookedParkingAdapter.ViewHolder(listItem);
    }

    @Override
    public void onBindViewHolder(@NonNull BookedParkingAdapter.ViewHolder holder, int position) {
